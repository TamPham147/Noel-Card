...
function showSantaClaus() {
    if (leftToRight == true) {
        leftToRight = false;
        endPos = $(window).width();
        $("img#santaClaus").attr("src", "imgs/santaclaus1.gif"); // Load santaclaus1.gif
        $("img#santaClaus").css("left", "-390px");
    } else {
        leftToRight = true;
        endPos = -390;
        $("img#santaClaus").attr("src", "imgs/santaclaus2.gif"); // Load santaclaus2.gif
            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Chúc chị một mùa Giáng Sinh an lành, ấm áp bên gia đình và những người thân yêu. Mong rằng năm mới sẽ mang đến cho chị thật nhiều niềm vui, hạnh phúc và thành công!",
                        ],
                        typeSpeed: 250,
                        startDelay: 100,
                        backSpeed: 500,
